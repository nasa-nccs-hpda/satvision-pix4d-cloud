...
#SBATCH -J abi_cloudsat_collocation_1600_1day_goes19               # Job name
...
python /explore/nobackup/projects/pix4dcloud/aliewehr/satvision-pix4d/satvision_pix4d/view/cloudsat_abi_cropping_cli.py \
  --abi-root /css/geostationary/NonOptimized/L1/GOES-19-ABI-L1B-FULLD \
  --cloudsat-root /explore/nobackup/projects/pix4dcloud/szhang16/cloudsat \
  --output-dir /explore/nobackup/projects/pix4dcloud/aliewehr/oneDayTests/goes19/1600_bound \
