...
#SBATCH -c 40                                      # Request 10 CPU cores
#SBATCH --mem=128G                                 # Request 64 GB of memory
#SBATCH -J abi_cloudsat_collocation_1600_1day_goes16 # Job name
...
python /explore/nobackup/projects/pix4dcloud/aliewehr/satvision-pix4d/satvision_pix4d/view/cloudsat_abi_cropping_cli.py \
  ...
  --output-dir /explore/nobackup/projects/pix4dcloud/aliewehr/chipTests/test_07_07_2026 \
