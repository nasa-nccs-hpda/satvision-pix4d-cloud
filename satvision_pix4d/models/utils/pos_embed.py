...
# Adapted from https://github.com/sustainlab-group/SatMAE/blob/main/util/pos_embed.py
# --------------------------------------------------------
...
def get_2d_sincos_pos_embed(embed_dim, grid_size, cls_token=False):
    """
    grid_size: int or (grid_h, grid_w) tuple for asymmetric grids.
    """
    if isinstance(grid_size, (list, tuple)):
        grid_h_size, grid_w_size = grid_size
    else:
        grid_h_size = grid_w_size = int(grid_size)
